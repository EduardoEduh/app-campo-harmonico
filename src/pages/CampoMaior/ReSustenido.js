    ...
    return(
        <Body>
            <Scroll>
                <Body>
                    <ContainerText>
                        <Texto>Campo Harmônico de Ré Sustenido ou Mi Bemol Maior</Texto>
                    </ContainerText>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/ReSus.png')}/>
                    </ContainerImage>

                        
                    <ContainerImage>
                        <Imagem source={require('../images/Maior/Bemol/Mib.png')}/>
                    </ContainerImage>
                <Status hidden={true}/>
                </Body>
            </Scroll>
