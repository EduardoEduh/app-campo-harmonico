    ...
    return(
        <Body>
            <Scroll>
                <Body>
                    <ContainerText>
                        <Texto>Campo Harmônico de Sol Sustenido ou Lá Bemol Maior</Texto>
                    </ContainerText>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/SolSus.png')}/>
                    </ContainerImage>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/Bemol/Lab.png')}/>
                    </ContainerImage>
                    <Status hidden={true}/>
                </Body>
            </Scroll>
...
SolSustenido.navigationOptions = ()=>{
    return{
        headerStyle:{
