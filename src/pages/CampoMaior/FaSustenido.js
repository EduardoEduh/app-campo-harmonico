    ...
    return(
        <Body>
            <Scroll>
                <Body>
                    <ContainerText>
                        <Texto>Campo Harmônico de Fá Sustenido ou Sol Bemol Maior</Texto>
                    </ContainerText>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/FaSus.png')}/>
                    </ContainerImage>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/Bemol/Solb.png')}/>
                    </ContainerImage>
                <Status hidden={true}/>
                </Body>
            </Scroll>
