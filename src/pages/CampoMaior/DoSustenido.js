    ...
    return(
        <Body>
            <Scroll>
                <Body>
                    <ContainerText>
                        <Texto>Campo Harmônico de Dó Sustenido ou Ré Bemol Maior</Texto>
                    </ContainerText>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/DoSus.png')}/>
                    </ContainerImage>

                    <ContainerImage>
                        <Imagem source={require('../images/Maior/Bemol/Reb.png')}/>
                    </ContainerImage>
                <Status hidden={true}/>
                </Body>
            </Scroll>
