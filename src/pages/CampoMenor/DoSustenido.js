    ...
    return(
        <Body>
            <Scroll>
                <Body>
                    <ContainerText>
                        <Texto>Campo Harmônico de Dó Sustenido Menor</Texto>
                    </ContainerText>

                    <ContainerImage>
                        <Imagem source={require('../images/Menor/CSm.png')}/>
                    </ContainerImage>
                <Status hidden={true}/>
                </Body>
            </Scroll>
...
DoSustenidoM.navigationOptions = ()=>{
    return{
        headerStyle:{
